...
public class GFG {
    public static String s01_create;
    public static String s01_create1;
    public static String s01_AM_create;
    public static String s01_AM_create1;
    public static String s02_AM_complete;
    public static String s02_AM_complete1;

    //public String csvsheet1 = "/Users/manivannanpanneerselvam/Downloads/s12_shareclass_create.xlsx";
    //public String s01_create1="/Users/manivannanpanneerselvam/Downloads/s01_create.csv";

    public static void main(String arg[]) {

  //  }
        String loadtestdata = arg[0];
        System.out.println("Types of Test Data "+loadtestdata);
//    public static void readcsv(String ls[])
//    {
        //String arg;
...
//        int x = Integer.parseInt(arg[0]); //first arguments
//        int y = Integer.parseInt(arg[1]); //second arguments
//        int sum = x + y;
...
//              {
            ...
            data.put("" + i + "",
                        new Object[]{"Am_pf_"+loadtestdata+"_create"+formatDate.format(date)+"_ "+j+"", "Am_legal_lt1_create" + formatDate.format(date) + "", "Am_TStar_create" + formatDate.format(date) + ""});

                data1.put("" + i + "",
                        new Object[]{"Am_pf_LT1_complete"+formatDate.format(date)+"_ "+j+"", "Am_legal_lt1_complete" + formatDate.format(date) + "", "Am_TStar_complete" + formatDate.format(date) + ""});

                data2.put("" + i + "",
                        new Object[]{"Am_pf_LT1_complete" + formatDate.format(date) + " "});

                data3.put("" + i + "",
                        new Object[]{"Am_pf_LT1_Update" + formatDate.format(date) + " ", "Am_legal_lt1_update" + formatDate.format(date) + "", "Am_TStar_update" + formatDate.format(date) + ""});


                data5.put("" + i + "",
                        new Object[]{"Bm_GAA_LT1_create" + formatDate.format(date) + " ", "BM_CRTSCD_lt1_create" + formatDate.format(date) + ""});

                data6.put("" + i + "",
                        new Object[]{"Bm_GAA_LT1_complete" + formatDate.format(date) + " ", "BM_CRTSCD_lt1_complete" + formatDate.format(date) + ""});

                data6.put("" + i + "",
                        new Object[]{"Bm_GAA_LT1_complete" + formatDate.format(date) + " ", "BM_CRTSCD_lt1_complete" + formatDate.format(date) + ""});

                data7.put("" + i + "",
                        new Object[]{"Bm_GAA_LT1_update" + formatDate.format(date) + " ", "BM_CRTSCD_lt1_update" + formatDate.format(date) + ""});

                data8.put("" + i + "",
                        new Object[]{"Is_LT1_create" + formatDate.format(date) + " ", "Is_Desc_LT1_create" + formatDate.format(date) + "", "Is_RDM_create" + formatDate.format(date) + ""});

                data9.put("" + i + "",
                        new Object[]{"Is_LT1_complete" + formatDate.format(date) + " ", "Is_Desc_LT1_complete" + formatDate.format(date) + "", "Is_RDM_complete" + formatDate.format(date) + ""});

                data10.put("" + i + "",
                        new Object[]{"Is_LT1_update" + formatDate.format(date) + " ", "Is_Desc_LT1_update" + formatDate.format(date) + "", "Is_RDM_update" + formatDate.format(date) + ""});

                data11.put("" + i + "",
                        new Object[]{"Insti_LT1_create" + formatDate.format(date) + " ", "Insti_LT1_create" + formatDate.format(date) + "", "Insti_LT1_create" + formatDate.format(date) + ""});

                data12.put("" + i + "",
                        new Object[]{"Insti_LT1_complete" + formatDate.format(date) + " ", "Insti_LT1_complete" + formatDate.format(date) + "", "Insti_LT1_complete" + formatDate.format(date) + ""});

                data13.put("" + i + "",
                        new Object[]{"sc_LT1_create" + formatDate.format(date) + " ", "sc_LT1_create" + formatDate.format(date) + "", "sc_LT1_create" + formatDate.format(date) + ""});

                data14.put("" + i + "",
                        new Object[]{"sc_LT1_complete" + formatDate.format(date) + " ", "sc_LT1_complete" + formatDate.format(date) + "", "sc_LT1_complete" + formatDate.format(date) + ""});

                data15.put("" + i + "",
                        new Object[]{"sc_LT1_update" + formatDate.format(date) + " ", "sc_LT1_update" + formatDate.format(date) + "", "sc_LT1_update" + formatDate.format(date) + ""});
            ...
            for (String key : keyset01) {
                ...
                try {
                    ...
                    s01_create="/Users/manivannanpanneerselvam/Downloads/s0451_create.xlsx";
                    s01_create1="/Users/manivannanpanneerselvam/Downloads/s0451_create.csv";

                    FileOutputStream out = new FileOutputStream(
                            new File(s01_create));
                    workbook.write(out);

//                    ConvertExcelToCSV obj = new ConvertExcelToCSV();
//                    obj.syahello(String v1);

                    ConvertExcelToCSV.syahello(s01_create,s01_create1);


                    s01_AM_create="/Users/manivannanpanneerselvam/Downloads/Datasetup_complete/s01_AM_create.xlsx";
                    s01_AM_create1="/Users/manivannanpanneerselvam/Downloads/Datasetup_complete/s01_AM_create.csv";

                    FileOutputStream out1 = new FileOutputStream(
                            new File(s01_AM_create));
                    workbook1.write(out1);

                    ConvertExcelToCSV.syahello(s01_AM_create,s01_AM_create1);

                    s02_AM_complete = "/Users/manivannanpanneerselvam/Downloads/s02_AM_complete.xlsx";
                    s02_AM_complete1="/Users/manivannanpanneerselvam/Downloads/s02_AM_complete.csv";

                    FileOutputStream out2 = new FileOutputStream(
                            new File(s02_AM_complete));
                    workbook2.write(out2);
                    ConvertExcelToCSV.syahello(s02_AM_complete,s02_AM_complete1);
